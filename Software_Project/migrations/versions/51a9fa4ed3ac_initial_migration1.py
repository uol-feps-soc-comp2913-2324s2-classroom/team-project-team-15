...
Revision ID: 51a9fa4ed3ac
Revises: df3e5fdd72c7
Create Date: 2024-03-13 02:39:41.805094
...
revision = '51a9fa4ed3ac'
down_revision = 'df3e5fdd72c7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('gps_data', sa.Text(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
